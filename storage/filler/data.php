...
/*men*/
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		        ...
		        VALUES ('2', 'maximus', 'Maxim', 'Chumko', '1995-12-28', 'male', 'heterosexual', '1', '$bio',
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		        ...
		        VALUES ('3', 'dobby', 'Alexander', 'Cherednichok', '1985-05-20', 'male', 'heterosexual', '1', '$bio',
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		        ...
		        VALUES ('4', 'bigboy', 'Ruslan', 'Drobyazko', '1977-05-01', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/bigboy/avatar.jpg', '1',
		                'images/profiles/bigboy/photo1.jpg', '14.4');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, photo1, photo2, rating)
		        VALUES ('5', 'captain', 'Vlad', 'kropolenko', '1978-05-01', 'male', 'heterosexual', '1', '$bio',
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		        ...
		        VALUES ('6', 'serious', 'Nikolay', 'Kuzhko', '2000-03-05', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/serious/avatar.jpg', '1', '3.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, photo1, photo2, rating)
		        VALUES ('7', 'massive', 'Sergey', 'Stanko', '1989-02-21', 'male', 'heterosexual', '1', '$bio',
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, photo1, photo2, photo3, rating)
		        VALUES ('8', 'johnny', 'Denis', 'Petrenko', '1987-02-10', 'male', 'heterosexual', '1', '$bio',
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, photo1, photo2, photo3, photo4, rating)
		        VALUES ('9', 'womanizer', 'Pavel', 'Kunickii', '1982-12-10', 'male', 'heterosexual', '1', '$bio',
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, photo1, photo2, rating)
		        VALUES ('10', 'beast', 'Fedor', 'Emalnyanenko', '1977-10-12', 'male', 'heterosexual', '1', '$bio',
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('11', 'cooler', 'Vladimir', 'Markov', '1993-06-12', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/cooler/avatar.jpg', '1', '33.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('12', 'kipsta', 'Vadim', 'Markovenko', '1988-07-07', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/kipsta/avatar.jpg', '1', '23.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('13', 'ehorro', 'Ehor', 'Putenko', '1984-03-11', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/ehorro/avatar.jpg', '1', '5.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('14', 'sergio', 'Sergey', 'Leonenko', '1991-06-01', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/sergio/avatar.jpg', '1', '6.9');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('15', 'kopa', 'Kiril', 'Eremenko', '1978-09-01', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/kopa/avatar.jpg', '1', '10.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('16', 'dimas', 'Dmitrii', 'Golovko', '1993-10-11', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/dimas/avatar.jpg', '1', '6.3');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('17', 'nubilas', 'Nikolay', 'Lasiskii', '1987-06-11', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/nubilas/avatar.jpg', '1', '9.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('18', 'rubae', 'Nikita', 'Alexeev', '1998-06-01', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/rubae/avatar.jpg', '1', '19.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('19', 'crop', 'Oleksii', 'Rudchenko', '1991-02-01', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/crop/avatar.jpg', '1', '8.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('20', 'super', 'Slava', 'Lepsheev', '1986-01-02', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/super/avatar.jpg', '1', '10.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('21', 'rudolf', 'Rudolf', 'Shneer', '1974-06-27', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/rudolf/avatar.jpg', '1', '20.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('22', 'patriot', 'Andrey', 'Bilko', '1981-12-01', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/patriot/avatar.jpg', '1', '40.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('23', 'cool', 'Sasha', 'Andrienko', '1987-03-11', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/cool/avatar.jpg', '1', '31.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('24', 'camagru', 'Franz', 'Herion', '1982-03-17', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/camagru/avatar.jpg', '1', '20.9');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('25', 'manu', 'Oleksii', 'Shumko', '1999-01-02', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/manu/avatar.jpg', '1', '69.9');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('26', 'shrai', 'Maksim', 'Marchuk', '2000-06-01', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/shrai/avatar.jpg', '1', '8.9');   

        INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('27', 'virgo', 'Vova', 'Klimchuk', '1984-03-20', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/virgo/avatar.jpg', '1', '17.9'); 

        INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('28', 'kupor', 'Konstantin', 'Grigorenko', '1987-09-22', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/kupor/avatar.jpg', '1', '51.9');  	

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('29', 'vitalino', 'Vitalii', 'Zaicev', '1976-02-03', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/vitalino/avatar.jpg', '1', '77.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('30', 'phobiq', 'Alexander', 'Shiyan', '1984-09-22', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/phobiq/avatar.jpg', '1', '25.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('31', 'cutor', 'Borislav', 'Romanov', '1988-08-02', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/cutor/avatar.jpg', '1', '18.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('32', 'longer', 'Garri', 'Frolov', '1993-10-12', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/longer/avatar.jpg', '1', '41.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('33', 'strong', 'Gordeii', 'Sergeev', '1979-09-22', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/strong/avatar.jpg', '1', '41.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('34', 'stigor', 'German', 'Sorokin', '1980-10-23', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/stigor/avatar.jpg', '1', '24.9');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('35', 'ivor', 'Ivor', 'Muleev', '1994-10-22', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/ivor/avatar.jpg', '1', '7.9');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('36', 'nesamovitii', 'Ihor', 'Korolev', '1993-12-31', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/nesamovitii/avatar.jpg', '1', '34.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('37', 'insane', 'David', 'Tarasov', '1971-09-22', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/insane/avatar.jpg', '1', '66.9');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('38', 'ilnev', 'Itan', 'Ilnev', '1978-10-02', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/ilnev/avatar.jpg', '1', '81.9');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('39', 'ruban', 'Sergey', 'Ruaban', '1984-09-02', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/ruban/avatar.jpg', '1', '90.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('40', 'silver', 'Zurab', 'Zufar', '1987-09-02', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/silver/avatar.jpg', '1', '55.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('41', 'king', 'Petro', 'Poroshenko', '1964-10-10', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/king/avatar.jpg', '1', '33.2');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('42', 'best', 'Vladimir', 'Zelenskii', '1979-07-22', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/best/avatar.jpg', '1', '17.2');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('43', 'sadovii', 'Andrii', 'Sadovii', '1971-03-02', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/sadovii/avatar.jpg', '1', '18.4');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('44', 'muraev', 'Evgenii', 'Muraev', '1977-12-22', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/muraev/avatar.jpg', '1', '20.1'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('45', 'juda', 'Vladimir', 'Groysman', '1979-12-22', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/juda/avatar.jpg', '1', '9.9');     

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('46', 'stefa', 'Stanislav', 'Stefanchuk', '1981-07-29', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/stefa/avatar.jpg', '1', '12.2');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('47', 'slava', 'Slava', 'Vakarchuk', '1979-12-22', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/slava/avatar.jpg', '1', '18.3');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('48', 'vilkul', 'Ruslan', 'Vilkul', '1977-09-12', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/vilkul/avatar.jpg', '1', '23.7');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('49', 'shar', 'Anatolii', 'Sharii', '1978-02-23', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/shar/avatar.jpg', '1', '20.0');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('50', 'zhan', 'Zhan', 'Belenyuk', '1990-09-22', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/zhan/avatar.jpg', '1', '20.4');    

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('51', 'blackfire', 'Oleksii', 'Dmitrenko', '1988-11-16', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/blackfire/avatar.jpg', '1', '27.3'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('52', 'belka', 'Dmitrii', 'Belchenko', '1989-02-22', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/belka/avatar.jpg', '1', '77.3');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('53', 'rusik', 'Ruslan', 'Zshmachenko', '1989-03-12', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/rusik/avatar.jpg', '1', '28.9');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('54', 'beatmaker', 'Denis', 'Kuszhelnii', '1989-12-07', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/beatmaker/avatar.jpg', '1', '37.3'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('55', 'mordar', 'Oleh', 'Mordachev', '1990-09-30', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/mordar/avatar.jpg', '1', '57.3');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('56', 'serg', 'Sergey', 'Morshin', '1986-09-06', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/serg/avatar.jpg', '1', '96.3');    

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('57', 'bard', 'Sergey', 'Bardachenko', '1989-12-22', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/bard/avatar.jpg', '1', '44.5');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('58', 'dminakov', 'Denis', 'Minakov', '1992-10-22', 'male', 'heterosexual', '1', '$bio', 
		        		'images/profiles/dminakov/avatar.jpg', '1', '50.0');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('59', 'olrudenk', 'Oleksii', 'Rudenko', '1988-09-22', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/olrudenk/avatar.jpg', '1', '40.1');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('60', 'yora', 'Yura', 'Tigibko', '1994-09-24', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/yora/avatar.jpg', '1', '13.0');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('61', 'bulb', 'Dmitrii', 'Bulbotenko', '1987-05-15', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/bulb/avatar.jpg', '1', '41.2');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('62', 'ramzes', 'Roma', 'Tkachenko', '1987-05-16', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/ramzes/avatar.jpg', '1', '17.7');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('63', 'baboshka', 'Dmitrii', 'Baboshkin', '1987-07-15', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/baboshka/avatar.jpg', '1', '20.1');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('64', 'wrestler', 'Maksim', 'Goncharenko', '1992-05-15', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/wrestler/avatar.jpg', '1', '9.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('65', 'rovnii', 'Yaroslav', 'Rovnii', '1989-12-15', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/rovnii/avatar.jpg', '1', '7.4');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('66', 'kiparis', 'Maksim', 'Kalinskii', '1988-11-15', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/kiparis/avatar.jpg', '1', '27.4'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('67', 'gulechko', 'Sergii', 'Gulechko', '1988-12-13', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/gulechko/avatar.jpg', '1', '24.8');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('68', 'kaban', 'Ilya', 'Danyuk', '1994-09-17', 'male', 'heterosexual', '1', '$bio', 
		        		'images/profiles/kaban/avatar.jpg', '1', '33.6');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('69', 'sidor', 'Oleksii', 'Sirdorenko', '1978-04-07', 'male', 'heterosexual', '1', '$bio',
		                'images/profiles/sidor/avatar.jpg', '1', '44.1');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('70', 'razumnii', 'Andrii', 'Razumnii', '1977-12-07', 'male', 'heterosexual', '1', '$bio',
...
/*women*/
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, photo1, photo2, rating)
		        VALUES ('71', 'cherry', 'Alexandra', 'Cherry', '1993-06-07', 'female', 'heterosexual', '1', '$bio',
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, photo1, rating)
		        VALUES ('72', 'caroline', 'Carolina', 'Samsenko', '1994-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/caroline/avatar.jpg', '1',
		                'images/profiles/caroline/photo1.jpg', '34.4');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, photo1, rating)
		        VALUES ('73', 'kichi', 'Lilly', 'Ambrusko', '1988-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/kichi/avatar.jpg', '1',
		                'images/profiles/kichi/photo1.jpg', '44.4');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, photo1, photo2, photo3, photo4, rating)
		        VALUES ('74', 'pretty', 'Annet', 'Dobkina', '1978-06-07', 'female', 'heterosexual', '1', '$bio',
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, photo1, photo2, rating)
		        VALUES ('75', 'tiny', 'Ella', 'Hmara', '1981-06-07', 'female', 'heterosexual', '1', '$bio',
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('76', 'sunny', 'Kate', 'Johnson', '1984-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/sunny/avatar.jpg', '1', '13.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, photo1, photo2, rating)
		        VALUES ('77', 'leonna', 'Leona', 'Klimchak', '1975-06-07', 'female', 'heterosexual', '1', '$bio',
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, photo1, photo2, rating)
		        VALUES ('78', 'chika', 'Lera', 'Illenko', '1998-06-07', 'female', 'heterosexual', '1', '$bio',
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, photo1, rating)
		        VALUES ('79', 'love', 'Kseniya', 'Adamenko', '1988-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/love/avatar.jpg', '1',
		                'images/profiles/love/photo1.jpg', '14.4');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('80', 'cloudy', 'Tanita', 'Kum', '1963-06-07', 'female', 'heterosexual', '1', '$bio', 
		        		'images/profiles/cloudy/avatar.jpg', '1', '4.4');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('81', 'vika', 'Victoria', 'Bilenko', '1992-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/vika/avatar.jpg', '1', '31.9'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('82', 'samara', 'Samara', 'Morgan', '1995-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/samara/avatar.jpg', '1', '11.9');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('83', 'kitty', 'Kateryna', 'Rodchenko', '1994-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/kitty/avatar.jpg', '1', '24.9'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('84', 'anna', 'Anna', 'Tomchuk', '1992-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/anna/avatar.jpg', '1', '40.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('85', 'kissa', 'Valya', 'Shomko', '1988-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/kissa/avatar.jpg', '1', '10.2'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('86', 'catty', 'Nina', 'Alieva', '1986-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/catty/avatar.jpg', '1', '25.5'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('87', 'flower', 'Anabet', 'Kozachenko', '1989-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/flower/avatar.jpg', '1', '14.7'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('88', 'igirl', 'Alisa', 'Moloyovich', '1992-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/igirl/avatar.jpg', '1', '70.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('89', 'cute', 'Ira', 'Titarenko', '1997-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/cute/avatar.jpg', '1', '8.5');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('90', 'reddy', 'Valeria', 'Fuks', '1986-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/reddy/avatar.jpg', '1', '41.2');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('91', 'miumiu', 'Lida', 'Goloborodchenko', '1975-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/miumiu/avatar.jpg', '1', '45.2'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('92', 'murmur', 'Tanya', 'Morzeeva', '1999-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/murmur/avatar.jpg', '1', '78.7');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('93', 'hello', 'Olga', 'Kushmak', '1990-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/hello/avatar.jpg', '1', '27.9');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('94', 'yours', 'Kateryna', 'Tarashanskaya', '1988-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/yours/avatar.jpg', '1', '10.2');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('95', 'little', 'Dariia', 'Ivanova', '1986-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/little/avatar.jpg', '1', '50.2'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('96', 'potion', 'Anastasia', 'Ivleva', '1984-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/potion/avatar.jpg', '1', '31.8');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('97', 'bird', 'Vika', 'Fomenko', '1992-06-07', 'female', 'heterosexual', '1', '$bio',
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('99', 'beloved', 'Alexandra', 'Titakova', '1986-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/beloved/avatar.jpg', '1', '88.5'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('100', 'pet', 'Evgenia', 'Dobrovolskaya', '1994-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/pet/avatar.jpg', '1', '11.2');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('101', 'petty', 'Jane', 'Lavrinets', '1990-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/petty/avatar.jpg', '1', '15.2');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('102', 'sexxxy', 'Elvira', 'Sexxxy', '1984-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/sexxxy/avatar.jpg', '1', '98.7');     

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('103', 'curl', 'Alina', 'Grosu', '1991-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/curl/avatar.jpg', '1', '25.0');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('104', 'wave', 'Tamara', 'Gurieva', '1989-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/wave/avatar.jpg', '1', '60.2');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('105', 'morning', 'Marina', 'Nakonechnaya', '1988-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/morning/avatar.jpg', '1', '20.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('106', 'evening', 'Kira', 'Ninova', '1997-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/evening/avatar.jpg', '1', '81.8'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('107', 'sunset', 'Zara', 'Fomenchenko', '1984-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/sunset/avatar.jpg', '1', '14.5');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('108', 'sun', 'Sofia', 'Dron', '1993-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/sun/avatar.jpg', '1', '77.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('109', 'sea', 'Sasha', 'Ivanko', '1979-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/sea/avatar.jpg', '1', '18.5');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('110', 'wild', 'Elena', 'Kiss', '1976-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/wild/avatar.jpg', '1', '31.1');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('111', 'wildy', 'Fiona', 'Lavrok', '1985-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/wildy/avatar.jpg', '1', '25.2');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('112', 'tiger', 'Vera', 'Voichuk', '1987-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/tiger/avatar.jpg', '1', '18.7'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('113', 'puma', 'Veronika', 'Mumko', '1983-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/puma/avatar.jpg', '1', '35.0');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('114', 'clever', 'Tatyana', 'Golovko', '1974-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/clever/avatar.jpg', '1', '16.2');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('115', 'krispi', 'Margo', 'Nakos', '1968-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/krispi/avatar.jpg', '1', '7.5');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('116', 'kuki', 'Anna', 'Kovaleva', '1998-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/kuki/avatar.jpg', '1', '89.8');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('117', 'shevy', 'Gina', 'Soloveeva', '1993-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/shevy/avatar.jpg', '1', '34.5');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('118', 'compari', 'Sofia', 'Burbak', '1991-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/compari/avatar.jpg', '1', '17.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('119', 'mara', 'Marina', 'Ivashevich', '1988-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/mara/avatar.jpg', '1', '38.5');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('120', 'martini', 'Galya', 'Onoprienko', '1998-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/martini/avatar.jpg', '1', '11.1'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('121', 'tiva', 'Malvina', 'Yakimchuk', '1989-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/tiva/avatar.jpg', '1', '45.2');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('122', 'jodi', 'Liza', 'Loik', '2000-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/jodi/avatar.jpg', '1', '78.1'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('123', 'matilda', 'Matilda', 'Vovko', '1992-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/matilda/avatar.jpg', '1', '15.0');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('124', 'kilimondshara', 'Liza', 'Boyko', '1979-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/kilimondshara/avatar.jpg', '1', '26.2');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('125', 'bestgirlinyourlife', 'Anna', 'Radchenko', '1999-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/bestgirlinyourlife/avatar.jpg', '1', '77.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('126', 'cabanga', 'Evelena', 'Hoienko', '1998-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/cabanga/avatar.jpg', '1', '19.8');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('127', 'shmoka', 'Yana', 'Solomko', '1992-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/shmoka/avatar.jpg', '1', '24.5'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('128', 'casatca', 'Laura', 'Bonitta', '1993-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/casatca/avatar.jpg', '1', '37.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('129', 'barcelona', 'Hanna', 'Africa', '1986-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/barcelona/avatar.jpg', '1', '58.9'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('130', 'cosmo', 'Jannet', 'Kovalchuk', '1992-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/cosmo/avatar.jpg', '1', '71.1');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('131', 'teva', 'Angelina', 'Yakumiv', '1986-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/teva/avatar.jpg', '1', '15.2');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('132', 'monka', 'Inna', 'Martinyuk', '1987-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/monka/avatar.jpg', '1', '48.1');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('133', 'viva', 'Inga', 'Kumko', '1988-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/viva/avatar.jpg', '1', '65.0');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('134', 'cuttiest', 'Izabella', 'Dmutriv', '1985-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/cuttiest/avatar.jpg', '1', '26.1');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('135', 'light', 'Rita', 'Petrova', '1997-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/light/avatar.jpg', '1', '17.5');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('136', 'cuba', 'Elza', 'Buzina', '1994-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/cuba/avatar.jpg', '1', '39.2');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('137', 'kimi', 'Yanita', 'Solko', '1990-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/kimi/avatar.jpg', '1', '34.5');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('138', 'enrose', 'Roza', 'Shneimann', '1991-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/enrose/avatar.jpg', '1', '87.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('139', 'tictac', 'Anna', 'Greckaya', '1986-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/tictac/avatar.jpg', '1', '18.9');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('140', 'miracle', 'Tata', 'Yurova', '1987-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/miracle/avatar.jpg', '1', '21.1');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('141', 'fabious', 'Simona', 'Bushanina', '1990-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/fabious/avatar.jpg', '1', '19.2'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('142', 'beautiful', 'Yana', 'Sokolova', '1982-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/beautiful/avatar.jpg', '1', '84.5'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('143', 'fancy', 'Vera', 'Logdanidi', '1986-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/fancy/avatar.jpg', '1', '17.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('144', 'cozy', 'Monika', 'Belkova', '1970-06-07', 'female', 'heterosexual', '1', '$bio',
		                'images/profiles/cozy/avatar.jpg', '1', '99.2');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('145', 'mummy', 'Snezhana', 'Didenko', '1992-06-07', 'female', 'heterosexual', '1', '$bio',
...
/*homo men*/
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('146', 'shiva', 'Edgar', 'Zaharov', '1993-06-07', 'male', 'homosexual', '1', '$bio',
		                'images/profiles/shiva/avatar.jpg', '1', '19.2');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('147', 'como', 'Sasha', 'Kupchenko', '1991-06-07', 'male', 'homosexual', '1', '$bio',
		                'images/profiles/como/avatar.jpg', '1', '16.5');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('148', 'rapirus', 'Ehor', 'Shtutmann', '1994-06-07', 'male', 'homosexual', '1', '$bio',
		                'images/profiles/rapirus/avatar.jpg', '1', '17.7');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('149', 'komus', 'Lesha', 'Komarov', '1992-06-07', 'male', 'homosexual', '1', '$bio',
		                'images/profiles/komus/avatar.jpg', '1', '28.9');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('150', 'slaver', 'Serg', 'Yurov', '1994-06-07', 'male', 'homosexual', '1', '$bio',
		                'images/profiles/slaver/avatar.jpg', '1', '21.1');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('151', 'winner', 'Oleh', 'Kurtov', '1990-06-07', 'male', 'homosexual', '1', '$bio',
		                'images/profiles/winner/avatar.jpg', '1', '19.9'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('152', 'sweetty', 'Sweet', 'Candy', '1994-06-07', 'male', 'homosexual', '1', '$bio',
		                'images/profiles/sweetty/avatar.jpg', '1', '24.5'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('153', 'lover', 'Nikolya', 'Loshanskii', '1997-06-07', 'male', 'homosexual', '1', '$bio',
		                'images/profiles/lover/avatar.jpg', '1', '17.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('154', 'carlos', 'Carlos', 'Robeev', '1986-06-07', 'male', 'homosexual', '1', '$bio',
		                'images/profiles/carlos/avatar.jpg', '1', '24.2');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('155', 'shibu', 'Snezh', 'Didov', '1993-06-07', 'male', 'homosexual', '1', '$bio',
...
/*homo women*/
		...
		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('156', 'marta', 'Toto', 'Iiova', '1971-06-07', 'female', 'homosexual', '1', '$bio',
		                'images/profiles/marta/avatar.jpg', '1', '22.1');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('157', 'josse', 'Yanina', 'Sokolovko', '1988-06-07', 'female', 'homosexual', '1', '$bio',
		                'images/profiles/josse/avatar.jpg', '1', '14.5');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('158', 'liver', 'Linda', 'Kaufmann', '1991-06-07', 'female', 'homosexual', '1', '$bio',
		                'images/profiles/liver/avatar.jpg', '1', '27.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('159', 'ammuse', 'The', 'Greatest', '1988-06-07', 'female', 'homosexual', '1', '$bio',
		                'images/profiles/ammuse/avatar.jpg', '1', '18.9');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('160', 'constant', 'Olivia', 'Kuznecova', '1991-06-07', 'female', 'homosexual', '1', '$bio',
		                'images/profiles/constant/avatar.jpg', '1', '23.2');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('161', 'raptor', 'Juretta', 'Raptor', '1992-06-07', 'female', 'homosexual', '1', '$bio',
		                'images/profiles/raptor/avatar.jpg', '1', '29.2'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('162', 'lillo', 'Anastasia', 'Sopko', '1991-06-07', 'female', 'homosexual', '1', '$bio',
		                'images/profiles/lillo/avatar.jpg', '1', '14.5'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('163', 'quma', 'Vera', 'Shneev', '1986-06-07', 'female', 'homosexual', '1','$bio',
		                'images/profiles/quma/avatar.jpg', '1', '27.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('164', 'shiny', 'Tatyana', 'Baranina', '2000-09-17', 'female', 'homosexual', '1', '$bio',
		                'images/profiles/shiny/avatar.jpg', '1', '10.2');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('165', 'bubble', 'Olha', 'Kupova', '1973-02-13', 'female', 'homosexual', '1', '$bio',
		                'images/profiles/bubble/avatar.jpg', '1', '11.1');
/*bi men*/

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('166', 'corma', 'Andrew', 'Petrov', '1993-10-07', 'male', 'bisexual', '1', '$bio',
		                'images/profiles/corma/avatar.jpg', '1', '22.1');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('167', 'parabelum', 'Sergeii', 'Rudenko', '1991-06-07', 'male', 'bisexual', '1', '$bio',
		                'images/profiles/parabelum/avatar.jpg', '1', '14.5');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('168', 'kuzha', 'Ivan', 'Kuzha', '1991-06-07', 'male', 'bisexual', '1', '$bio',
		                'images/profiles/kuzha/avatar.jpg', '1', '27.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('169', 'snowden', 'Snow', 'Man', '1993-06-07', 'male', 'bisexual', '1', '$bio',
		                'images/profiles/snowden/avatar.jpg', '1', '18.9');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('170', 'everest', 'Ivor', 'Kuznecov', '1988-06-07', 'male', 'bisexual', '1', '$bio',
		                'images/profiles/everest/avatar.jpg', '1', '23.2');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('171', 'rapt', 'Oleksii', 'Jurko', '1992-06-07', 'male', 'bisexual', '1', '$bio',
		                'images/profiles/rapt/avatar.jpg', '1', '29.2'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('172', 'hovard', 'Hovard', 'Shusev', '1986-06-07', 'male', 'bisexual', '1', '$bio',
		                'images/profiles/hovard/avatar.jpg', '1', '14.5'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('173', 'harry', 'Harry', 'Prince', '1998-06-07', 'male', 'bisexual', '1', '$bio',
		                'images/profiles/harry/avatar.jpg', '1', '27.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('174', 'joom', 'Vitalii', 'Baranin', '1986-06-07', 'male', 'bisexual', '1', '$bio',
		                'images/profiles/joom/avatar.jpg', '1', '10.2');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('175', 'bubba', 'Yura', 'Konopalcev', '1985-06-07', 'male', 'bisexual', '1', '$bio',
		                'images/profiles/bubba/avatar.jpg', '1', '11.1');
/*bi women*/

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('176', 'bibba', 'Julia', 'Presnicka', '1988-06-07', 'female', 'bisexual', '1', '$bio',
		                'images/profiles/bibba/avatar.jpg', '1', '22.1');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('177', 'jorra', 'Yana', 'Rudenko', '1998-06-07', 'female', 'bisexual', '1', '$bio',
		                'images/profiles/jorra/avatar.jpg', '1', '14.5');  

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('178', 'komo', 'Anastasia', 'Ludenko', '1993-06-07', 'female', 'bisexual', '1', '$bio',
		                'images/profiles/komo/avatar.jpg', '1', '27.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('179', 'lerro', 'Lera', 'Gosmann', '1987-06-07', 'female', 'bisexual', '1', '$bio',
		                'images/profiles/lerro/avatar.jpg', '1', '18.9');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('180', 'petra', 'Petra', 'Livadia', '1991-06-07', 'female', 'bisexual', '1', '$bio',
		                'images/profiles/petra/avatar.jpg', '1', '23.2');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('181', 'rapira', 'Zarina', 'Star', '1989-06-07', 'female', 'bisexual', '1', '$bio',
		                'images/profiles/rapira/avatar.jpg', '1', '29.2'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('182', 'poppy', 'Dariia', 'Jurkevich', '1987-06-07', 'female', 'bisexual', '1', '$bio',
		                'images/profiles/poppy/avatar.jpg', '1', '14.5'); 

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('183', 'titta', 'Tatyana', 'Shom', '1996-06-07', 'female', 'bisexual', '1', '$bio',
		                'images/profiles/titta/avatar.jpg', '1', '27.5');

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('184', 'lossy', 'Lara', 'Ivankov', '1997-06-07', 'female', 'bisexual', '1', '$bio',
		                'images/profiles/lossy/avatar.jpg', '1', '10.2');   

		INSERT INTO profiles(user_id, login, name, surname, age, gender, preferences, preferences_specified, bio,
		                    avatar, avatar_uploaded, rating)
		        VALUES ('185', 'himma', 'Ira', 'Korneev', '1992-06-07', 'female', 'bisexual', '1', '$bio',
...
/*men*/
		...
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
        		VALUES ('2', 'Ukraine', 'Vinnica', '49.22561355', '28.46660614', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('3', 'Ukraine', 'Rivne', '50.61595175', '26.2410593', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('4', 'Ukraine', 'Chernihiv', '51.48841138', '31.28309727', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('5', 'Ukraine', 'Symu', '50.90327641', '34.78631973', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('6', 'Ukraine', 'Poltava', '49.58253211', '34.54865456', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('7', 'Ukraine', 'Lviv', '49.83395855', '24.02726591', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('8', 'Ukraine', 'Odessa', '46.45116389', '30.71737111', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('9', 'Ukraine', 'Odessa', '46.42627346', '30.73182821', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('10', 'Ukraine', 'Kherson', '46.63997141', '32.60959446', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('11', 'Ukraine', 'Kharkiv', '49.96991057', '36.23200893', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('12', 'Ukraine', 'Kharkiv', '49.92866567', '36.37463406', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('13', 'Ukraine', 'Ivano-Frankivsk', '48.9180842', '24.70593721', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('14', 'Germany', 'Berlin', '52.45193613', '13.37532341', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('15', 'France', 'Paris', '48.83385893', '2.34995842', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('16', 'Italy', 'Milan', '45.4557169', '9.20240968', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('17', 'Poland', 'Warsawa', '52.23980423', '21.01038158', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('18', 'Latvia', 'Riga', '56.94802586', '24.05907691', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('19', 'Norway', 'Oslo', '59.92121572', '10.73925376', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('20', 'Spain', 'Barcelona', '41.41330518', '2.21000344', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('21', 'Ukraine', 'Kyiv', '50.4611104', '30.35007477', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('22', 'Ukraine', 'Kyiv', '50.41715945', '30.35179138', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('23', 'Ukraine', 'Kyiv', '50.40381304', '30.38234711', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('24', 'Ukraine', 'Kyiv', '50.40622005', '30.37204742', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('25', 'Ukraine', 'Kyiv', '50.45411596', '30.3792572', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('26', 'Ukraine', 'Kyiv', '50.43618801', '30.42011261', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('27', 'Ukraine', 'Kyiv', '50.43006471', '30.47504425', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('28', 'Ukraine', 'Kyiv', '50.48711187', '30.46165466', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('29', 'Ukraine', 'Kyiv', '50.44930669', '30.50731659', '1');    
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
        		VALUES ('30', 'Ukraine', 'Kyiv', '50.45291369', '30.50662994', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('31', 'Ukraine', 'Kyiv', '50.42372189', '30.53203583', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('32', 'Ukraine', 'Kyiv', '50.47859196', '30.57186127', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('33', 'Ukraine', 'Kyiv', '50.46460722', '30.58525085', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('34', 'Ukraine', 'Kyiv', '50.43990534', '30.60207367', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('35', 'Ukraine', 'Kyiv', '50.42853376', '30.60001373', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('36', 'Ukraine', 'Kyiv', '50.41125249', '30.6281662', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('37', 'Ukraine', 'Kyiv', '50.40446951', '30.62610626', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('38', 'Ukraine', 'Kyiv', '50.4073141', '30.66009521', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('39', 'Ukraine', 'Kyiv', '50.46766674', '30.63091278', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('40', 'Ukraine', 'Kyiv', '50.51004248', '30.60447693', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('41', 'Ukraine', 'Kyiv', '50.49977968', '30.60276031', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('42', 'Ukraine', 'Kyiv', '50.45739473', '30.64704895', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('43', 'Ukraine', 'Kyiv', '50.4427478', '30.63640594', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('44', 'Ukraine', 'Kyiv', '50.50676736', '30.50079346', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('45', 'Ukraine', 'Kyiv', '50.50529348', '30.4930687', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('46', 'Ukraine', 'Kyiv', '50.50305528', '30.46955109', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('47', 'Ukraine', 'Kyiv', '50.48503665', '30.45135498', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('48', 'Ukraine', 'Kyiv', '50.43607867', '30.38955688', '1');	
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('49', 'Ukraine', 'Kyiv', '50.39199504', '30.63262939', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('50', 'Ukraine', 'Kyiv', '50.40425068', '30.62198639', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('51', 'Ukraine', 'Kyiv', '50.46045471', '30.59211731', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('52', 'Ukraine', 'Kyiv', '50.46285884', '30.58490753', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('53', 'Ukraine', 'Kyiv', '50.39090063', '30.56911469', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('54', 'Ukraine', 'Kyiv', '50.39768555', '30.5210495', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('55', 'Ukraine', 'Kyiv', '50.41212764', '30.63022614', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('56', 'Ukraine', 'Kyiv', '50.41278399', '30.65769196', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('57', 'Ukraine', 'Kyiv', '50.41540932', '30.63228607', '1');       
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('58', 'Ukraine', 'Kyiv', '50.41497177', '30.60619354', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('59', 'Ukraine', 'Kyiv', '50.40906453', '30.61855316', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('60', 'Ukraine', 'Kyiv', '50.46832232', '30.63159943', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('61', 'Ukraine', 'Kyiv', '50.45455314', '30.62782288', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('62', 'Ukraine', 'Kyiv', '50.42831505', '30.64979553', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('63', 'Ukraine', 'Kyiv', '50.42678405', '30.5979538', '1');	
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('64', 'Ukraine', 'Kyiv', '50.42197199', '30.53100586', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('65', 'Ukraine', 'Kyiv', '50.42153451', '30.53203583', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('66', 'Ukraine', 'Kyiv', '50.46701114', '30.52139282', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('67', 'Ukraine', 'Kyiv', '50.45258579', '30.50285339', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('68', 'Ukraine', 'Kyiv', '50.43859337', '30.50765991', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('69', 'Ukraine', 'Kyiv', '50.43247038', '30.46989441', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('70', 'Ukraine', 'Kyiv', '50.42765891', '30.4335022', '1'); 

/*women*/

		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
        		VALUES ('71', 'Spain', 'Barcelona', '41.39728428', '2.1478875', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('72', 'Spain', 'Madrid', '40.39035093', '-3.66169006', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('73', 'Turkey', 'Istambul', '41.03175981', '28.95041764', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('74', 'Italy', 'Rome', '41.91130779', '12.49515116', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('75', 'Hungary', 'Budapest', '47.48570954', '19.07313868', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('76', 'Poland', 'Krakow', '50.06934778', '19.96600851', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('77', 'Netherlands', 'Amsterdam', '52.36467281', '4.88644302', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('78', 'Netherlands', 'Antwerpen', '51.22356873', '4.44863141', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('79', 'Austria', 'Wien', '48.18537754', '16.36850774', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('80', 'Ukraine', 'Dnipro', '48.44484941', '35.03477275', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('81', 'Ukraine', 'Poltava', '49.58857091', '34.57857192', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('82', 'Ukraine', 'Kremenchuk', '49.06363164', '33.41302872', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('83', 'Ukraine', 'Odessa', '46.45484816', '30.75487107', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('84', 'Ukraine', 'Odessa', '46.42728614', '30.73615998', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('85', 'Ukraine', 'Kharkiv', '49.98860519', '36.32282183', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('86', 'Ukraine', 'Kharkiv', '49.97381361', '36.26377031', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('87', 'Ukraine', 'Brovaru', '50.5126462', '30.80028355', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('88', 'Ukraine', 'Obuhiv', '50.11595515', '30.62438965', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('89', 'Ukraine', 'Vushneve', '50.3799094', '30.37001029', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('90', 'Ukraine', 'Vinnica', '49.22444646', '28.48284423', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('91', 'Ukraine', 'Kyiv', '50.42651065', '30.59555054', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('92', 'Ukraine', 'Kyiv', '50.42826037', '30.61443329', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('93', 'Ukraine', 'Kyiv', '50.41480769', '30.65580368', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('94', 'Ukraine', 'Kyiv', '50.45559144', '30.61889648', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('95', 'Ukraine', 'Kyiv', '50.45362413', '30.6810379', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('96', 'Ukraine', 'Kyiv', '50.40977563', '30.62473297', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('97', 'Ukraine', 'Kyiv', '50.40102294', '30.62747955', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('98', 'Ukraine', 'Kyiv', '50.39369132', '30.64653397', '1');    
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
        		VALUES ('99', 'Ukraine', 'Kyiv', '50.38679637', '30.61477661', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('100', 'Ukraine', 'Kyiv', '50.42618257', '30.59675217', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('101', 'Ukraine', 'Kyiv', '50.37059478', '30.45444489', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('102', 'Ukraine', 'Kyiv', '50.39040814', '30.44345856', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('103', 'Ukraine', 'Kyiv', '50.38592075', '30.44260025', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('104', 'Ukraine', 'Kyiv', '50.43165028', '30.4343605', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('105', 'Ukraine', 'Kyiv', '50.4226829', '30.37479401', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('106', 'Ukraine', 'Kyiv', '50.45296834', '30.38560867', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('107', 'Ukraine', 'Kyiv', '50.45253114', '30.42766571', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('108', 'Ukraine', 'Kyiv', '50.46651944', '30.34578323', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('109', 'Ukraine', 'Kyiv', '50.50900538', '30.43453217', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('110', 'Ukraine', 'Kyiv', '50.41633909', '30.40174484', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('111', 'Ukraine', 'Kyiv', '50.4771172', '30.44019699', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('112', 'Ukraine', 'Kyiv', '50.51326279', '30.42886734', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('113', 'Ukraine', 'Kyiv', '50.4679399', '30.48740387', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('114', 'Ukraine', 'Kyiv', '50.44487954', '30.52911758', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('115', 'Ukraine', 'Kyiv', '50.43132224', '30.54130554', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('116', 'Ukraine', 'Kyiv', '50.46498967', '30.47401428', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('117', 'Ukraine', 'Kyiv', '50.46717504', '30.4810524', '1');		
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('118', 'Ukraine', 'Kyiv', '50.46630091', '30.46062469', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('119', 'Ukraine', 'Kyiv', '50.46367841', '30.47040939', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('120', 'Ukraine', 'Kyiv', '50.46356913', '30.47864914', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('121', 'Ukraine', 'Kyiv', '50.45668435', '30.44448853', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('122', 'Ukraine', 'Kyiv', '50.47897429', '30.44139862', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('123', 'Ukraine', 'Kyiv', '50.52177645', '30.461483', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('124', 'Ukraine', 'Kyiv', '50.51992104', '30.4668045', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('125', 'Ukraine', 'Kyiv', '50.50682194', '30.46388626', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('126', 'Ukraine', 'Kyiv', '50.49000611', '30.46440125', '1');       
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('127', 'Ukraine', 'Kyiv', '50.47088994', '30.40826797', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('128', 'Ukraine', 'Kyiv', '50.46826769', '30.41273117', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('129', 'Ukraine', 'Kyiv', '50.46848622', '30.42131424', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('130', 'Ukraine', 'Kyiv', '50.46029079', '30.37307739', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('131', 'Ukraine', 'Kyiv', '50.4588701', '30.36724091', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('132', 'Ukraine', 'Kyiv', '50.45198464', '30.38303375', '1');	
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('133', 'Ukraine', 'Kyiv', '50.45799582', '30.36226273', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('134', 'Ukraine', 'Kyiv', '50.45843296', '30.36741257', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('135', 'Ukraine', 'Kyiv', '50.45362413', '30.37015915', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('136', 'Ukraine', 'Kyiv', '50.41469831', '30.60670853', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('137', 'Ukraine', 'Kyiv', '50.40430539', '30.62868118', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('138', 'Ukraine', 'Kyiv', '50.39314414', '30.64035416', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('139', 'Ukraine', 'Kyiv', '50.39347245', '30.64979553', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('140', 'Ukraine', 'Kyiv', '50.39478566', '30.63262939', '1');  
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('141', 'Ukraine', 'Kyiv', '50.45876082', '30.58988571', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('142', 'Ukraine', 'Kyiv', '50.44859619', '30.52362442', '1');  
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('143', 'Ukraine', 'Kyiv', '50.44214653', '30.53255081', '1'); 	
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('144', 'Ukraine', 'Kyiv', '50.44990788', '30.49804688', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('145', 'Ukraine', 'Kyiv', '50.46630091', '30.47212601', '1');

/*homo men*/

		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
        		VALUES ('146', 'Ukraine', 'Kyiv', '50.39527811', '30.64670563', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('147', 'Ukraine', 'Kyiv', '50.38608493', '30.69957733', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('148', 'Ukraine', 'Kyiv', '50.36528426', '30.60722351', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('149', 'Ukraine', 'Kyiv', '50.43596933', '30.63537598', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('150', 'Ukraine', 'Kyiv', '50.44034265', '30.60001373', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('151', 'Ukraine', 'Kyiv', '50.48820406', '30.60516357', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('152', 'Ukraine', 'Kyiv', '50.57702335', '30.4788208', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('153', 'Ukraine', 'Kyiv', '50.50371037', '30.46199799', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('154', 'Ukraine', 'Kyiv', '50.46657408', '30.4668045', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('155', 'Ukraine', 'Kyiv', '50.42831505', '30.47813416', '1');

/*homo women*/

		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('156', 'Ukraine', 'Kyiv', '50.40206241', '30.48500061', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('157', 'Ukraine', 'Kyiv', '50.44733912', '30.51006317', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('158', 'Ukraine', 'Kyiv', '50.4390307', '30.41770935', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('159', 'Ukraine', 'Kyiv', '50.4919173', '30.46474457', '1');      
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('160', 'Ukraine', 'Kyiv', '50.47160011', '30.46749115', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('161', 'Ukraine', 'Kyiv', '50.44733912', '30.52276611', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('162', 'Ukraine', 'Kyiv', '50.43072081', '30.47676086', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('163', 'Ukraine', 'Kyiv', '50.42153451', '30.48843384', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('164', 'Ukraine', 'Kyiv', '50.42394062', '30.44208527', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('165', 'Ukraine', 'Kyiv', '50.47465917', '30.41152954', '1');

/*bi men*/

		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('166', 'Ukraine', 'Kyiv', '50.43334514', '30.42011261', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('167', 'Ukraine', 'Kyiv', '50.432033', '30.46268463', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('168', 'Ukraine', 'Kyiv', '50.39702899', '30.5241394', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('169', 'Ukraine', 'Kyiv', '50.4689779', '30.41015625', '1');      
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('170', 'Ukraine', 'Kyiv', '50.46395159', '30.4788208', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('171', 'Ukraine', 'Kyiv', '50.43247038', '30.54096222', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('172', 'Ukraine', 'Kyiv', '50.40381304', '30.41564941', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('173', 'Ukraine', 'Kyiv', '50.46089184', '30.36792755', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('174', 'Ukraine', 'Kyiv', '50.43968668', '30.5979538', '1');
		INSERT INTO locations(user_id, country, city, latitude, longitude, allow)
		        VALUES ('175', 'Ukraine', 'Kyiv', '50.41190885', '30.61855316', '1');
